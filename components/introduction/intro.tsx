  ...
  return (
    <div className="px-12 mt-10 md:mt-40 w-full flex flex-col items-center">
      <div className="flex flex-col  items-start  gap-6">
        ...
        <h1 className="text-4xl md:text-7xl font-bold fade-in delay-1">Atikur Rahman.</h1>
        <h3 className="md:text-6xl font-bold text-gray-400 fade-in delay-2">
          A passionate SEO Specialist.
        </h3>
        <p className="text-xl md:text-2xl text-gray-400 font-semibold mt-5 leading-[50px] fade-in delay-3">
          I&apos;m an experienced eCommerce{" "}
          <span className="font-bold text-slate-400 md:text-[26px]">
            SEO Specialist{" "}
          </span>
